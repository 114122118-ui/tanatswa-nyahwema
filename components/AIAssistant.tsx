...
export default function AIAssistant() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-3 z-40 flex max-h-[26rem] w-[calc(100vw-1.5rem)] max-w-sm flex-col rounded-2xl border border-white/10 bg-surface shadow-2xl sm:right-6 sm:w-96">
          {/* Header */}
          ...
          <div className="flex gap-2 border-t border-white/10 p-3">
            ...
            <button
              onClick={handleSend}
              className="rounded-lg bg-primary px-3 py-2 text-sm font-semibold text-[#25005a] transition hover:scale-105"
            >
              Send
            </button>
          </div>
